"""
Django settings for healthinsuranceusec_45592 project.
...
ROOT_URLCONF = 'healthinsuranceusec_45592.urls'
...
WSGI_APPLICATION = 'healthinsuranceusec_45592.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healthinsuranceusec_45592 API",
    "DESCRIPTION": "API documentation for healthinsuranceusec_45592 App",
    "VERSION": "v1",
}
